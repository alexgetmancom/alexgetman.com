...
export const socialTargets: SocialTargetConfig[] = z.array(socialTargetConfigSchema).parse([
  ...
  { id: "facebook_ru", label: "Facebook RU", language: "ru", enabledByDefault: false, requiredEnv: ["FACEBOOK_RU_PAGE_ID", "FACEBOOK_RU_PAGE_ACCESS_TOKEN"] },
  { id: "linkedin", label: "LinkedIn", language: "en", enabledByDefault: false, requiredEnv: ["LINKEDIN_AUTHOR_URN", "LINKEDIN_ACCESS_TOKEN"] },
  { id: "facebook", label: "Facebook EN", language: "en", enabledByDefault: false, requiredEnv: ["FACEBOOK_PAGE_ID", "FACEBOOK_PAGE_ACCESS_TOKEN"] },
  ...
  { id: "telegram_stories", label: "Telegram Stories", language: "ru", enabledByDefault: false, requiredEnv: ["TELEGRAM_CHANNEL_STORIES_API_ID", "TELEGRAM_CHANNEL_STORIES_API_HASH"] },
  { id: "instagram_stories_ru", label: "Instagram Stories RU", language: "ru", enabledByDefault: false, requiredEnv: ["INSTAGRAM_RU_USER_ID", "INSTAGRAM_RU_ACCESS_TOKEN"] },
  { id: "instagram_stories", label: "Instagram Stories EN", language: "en", enabledByDefault: false, requiredEnv: ["INSTAGRAM_EN_USER_ID", "INSTAGRAM_EN_ACCESS_TOKEN"] },
]);
