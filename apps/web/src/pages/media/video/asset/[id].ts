...
import { unsafeRuntimeDb } from "../../../../server/runtime.js";
...
function mediaAssetResponse(id: string | undefined, headOnly: boolean): Response {
  ...
  const asset = unsafeRuntimeDb()
    .sqlite.prepare("SELECT kind, local_path AS localPath, mime_type AS mimeType FROM studio_media_assets WHERE sha256=?")
