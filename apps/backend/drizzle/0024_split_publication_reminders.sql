...
CREATE INDEX `idx_x_activity_items_linked_post` ON `x_activity_items` (`linked_post_key`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_post_targets_updated_at` ON `post_targets` (`updated_at`);--> statement-breakpoint
CREATE TABLE `posts` (
...
--> statement-breakpoint
CREATE UNIQUE INDEX `idx_draft_sources_draft_url` ON `draft_sources` (`draft_id`,`url`);--> statement-breakpoint
CREATE INDEX `idx_draft_sources_draft_order` ON `draft_sources` (`draft_id`,`sort_order`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `idx_post_sources_post_url` ON `post_sources` (`post_id`,`url`);--> statement-breakpoint
CREATE INDEX `idx_post_sources_post_order` ON `post_sources` (`post_id`,`sort_order`);--> statement-breakpoint
...
CREATE INDEX `idx_post_events_created_at` ON `post_events` (`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `idx_publish_jobs_post_target_status` ON `publish_jobs` (`post_key`,`target`,`status`);--> statement-breakpoint
CREATE INDEX `idx_publish_jobs_message` ON `publish_jobs` (`message_id`,`target`);--> statement-breakpoint
