...
const en = {
  ...
  "common.schedule-parse-error":
    "I couldn't read that date and time. Send `HH:MM` or `DD.MM HH:MM` in {timezone}, for example `15.07 18:30`.",
  ...
  "action.enter-datetime": "⌨ Send a date and time: `15.07 18:30` ({timezone}).",
  ...
  "video.skip": "⏭ Skip",
  "video.schedule-target-prompt": "⌨ When to publish on {target}? Format: 15.07 18:30 ({timezone}).",
  ...
  "video.enter-datetime": "⌨ Enter a date and time, e.g.: 15.07 18:30 ({timezone}).",
...
const ru = {
  ...
  "common.schedule-parse-error":
    "Не удалось распознать дату и время. Отправьте `ЧЧ:ММ` или `ДД.ММ ЧЧ:ММ` по {timezone}, например `15.07 18:30`.",
  ...
  "action.enter-datetime": "⌨ Введите дату и время: `15.07 18:30` ({timezone}).",
  ...
  "video.schedule-target-prompt": "⌨ Когда опубликовать на {target}? Формат: 15.07 18:30 ({timezone}).",
  ...
  "video.enter-datetime": "⌨ Введите дату и время, например: 15.07 18:30 ({timezone}).",
