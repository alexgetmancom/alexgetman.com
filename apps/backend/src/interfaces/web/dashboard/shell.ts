...
<head>
  ...
  <style>
    ...
    .post-detail__title { color:var(--text-main); font-size:17px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; } .post-detail__media { display:flex; align-items:center; justify-content:flex-end; gap:6px; color:var(--text-secondary); text-align:right; } .post-detail__platform-summary { display:flex; flex-wrap:wrap; align-items:center; justify-content:flex-end; gap:4px 6px; width:100%; min-width:0; color:var(--text-secondary); } .post-detail__platform-marker { display:inline-flex; align-items:center; gap:3px; flex:0 0 auto; color:var(--text-secondary); } .post-detail__platform-marker .platform-mark { display:inline-flex; width:16px; height:16px; } .post-detail__platform-locale { padding:1px 4px; border:1px solid var(--border-soft); border-radius:4px; color:var(--text-muted); font-size:10px; font-weight:700; letter-spacing:.04em; white-space:nowrap; }
    ...
    .overview-platforms__more { display:block; margin-top:8px; border:0; border-radius:0; background:transparent; }
