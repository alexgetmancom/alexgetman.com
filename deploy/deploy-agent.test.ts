...
`,
    ...
    const agent = Bun.spawn([process.execPath, join(import.meta.dir, "deploy-agent.ts")], {
      env: {
        ...
        DEPLOY_COMPOSE_FILE: join(directory, "compose.yaml"),
        DEPLOY_IMAGE_ENV_FILE: imageEnv,
        DEPLOY_STATE_FILE: stateFile,
        DEPLOY_HEALTH_URL: `http://127.0.0.1:${supportPort}/readyz`,
        DEPLOY_CONTAINER_NAME: "backend",
