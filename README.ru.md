...
Caddy сам получает и продлевает TLS-сертификат, поэтому ни certbot, ни таймер продления настраивать не нужно. Через минуту:

- Публичный сайт: `https://ваш-домен/`
- Command Center: `https://ваш-домен/command-center`
